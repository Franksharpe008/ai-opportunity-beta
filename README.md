...
2. Generate report, hero image, vocal jingle (20-30s), and Maximilian-style narration
...
- Narration defaults to the Maximilian stack: `supertonic` with `SUPERTONIC_VOICE=James` mapped to local fallback `M2` unless overridden.

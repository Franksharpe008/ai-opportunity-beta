...
assert(core.includes('/api/intelligence'));assert(core.includes('process_run_hourly'));assert(!core.includes('workers.ai'));assert(!core.includes('openrouter'));assert(!core.includes('api.openai.com'));

...
const MOBILE_V10_JS=['lsc-v10-core.js','lsc-v10-ai-world.js','lsc-v10-mobile.js','lsc-v10-floor-ops.js','lsc-v10-hourly-performance.js','lsc-v10-verification-queue.js'];
const MANAGER_V10_CSS=['lsc-command-v10.css','lsc-v10-capacity.css','lsc-v10-brief.css'];
const MANAGER_V10_JS=['lsc-v10-core.js','lsc-v10-ai-world.js','lsc-v10-floor-ops.js','lsc-v10-ui.js','lsc-v10-verification-queue.js','lsc-v10-cause-extension.js','lsc-v10-capacity.js','lsc-v10-capacity-ui.js','lsc-v10-brief.js'];
...
async function materializeBase(live,dir,allowed){for(const name of allowed){const body=await text(`${live}/api/base?file=${encodeURIComponent(name)}`);fs.writeFileSync(path.join(dir,name),body)}}
...
console.log('SAFE IN-PLACE TOPOLOGY: V9 browser assets are local static files; manager protects original V9 APIs with OIDC; mobile uses live manager authority; V10 remains additive.');
